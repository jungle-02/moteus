...
SCALE_TYPES = [
    ...
    ScaleType([moteus.Register.PWM_PHASE_A,
               ...
               moteus.Register.AUX1_PWM1,
               moteus.Register.AUX1_PWM2,
               moteus.Register.AUX1_PWM3,
               moteus.Register.AUX1_PWM4,
               moteus.Register.AUX1_PWM5,
               moteus.Register.AUX2_PWM1,
               moteus.Register.AUX2_PWM2,
               moteus.Register.AUX2_PWM3,
               moteus.Register.AUX2_PWM4,
               moteus.Register.AUX2_PWM5,
               ],
